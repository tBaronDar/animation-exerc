...
export default function WelcomePage() {
  ...
  const yCity = useTransform(scrollY, [0, 500], [0, -150]);

  const scaleText = useTransform(scrollY, [0, 500], [1, 2]);
  const yText = useTransform(scrollY, [0, 200, 300, 500], [0, 50, 75, 350]);

  const yHero = useTransform(scrollY, [0, 500], [0, -330]);
  return (
    <>
